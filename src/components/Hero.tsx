...
const Hero = () => {
  ...
  return <div className="bg-white py-12 md:py-16 lg:py-20">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 space-y-4 sm:space-y-6">
            ...
            <div className="pt-4 sm:pt-6 grid grid-cols-4 gap-2 sm:gap-4">
              <StatisticsAnimation value={unemploymentRate} suffix="%" label="SA Unemployment Rate" isLarge={true} highlightColor="text-sa-blue" />
              
              <StatisticsAnimation value={atsPercentage} suffix="%" label="SA Employers Use ATS" isLarge={true} highlightColor="text-sa-blue" />
              
              <StatisticsAnimation value={applicantsCount} suffix="+" label="Applicants Per Job" isLarge={true} highlightColor="text-sa-blue" />
              
              <StatisticsAnimation value={impressionTime} suffix="s" label="To Make First Impression" isLarge={true} highlightColor="text-sa-blue" />
            </div>
          </div>
          ...
          <div className="flex-1 flex justify-center mt-6 lg:mt-0">
            <div className="relative w-full max-w-md">
              <div className="absolute inset-0 bg-gradient-to-r from-sa-blue/5 to-sa-green/5 rounded-xl blur-lg transform scale-105" style={{
              zIndex: 0
            }}></div>
